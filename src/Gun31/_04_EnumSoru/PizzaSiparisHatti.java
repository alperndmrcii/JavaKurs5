...
public class PizzaSiparisHatti {
    ...
    // seçeneklerini bir menü şeklinde vererek, sipariş verdiği pizzaları
    ...
    public static void main(String[] args) {
       ...
       do {
           //menu
           menu();
           secim= oku.nextInt();//scannerla secimi alalım
          switch (secim){
              case 1: // small
    ...
    public static void siparisYazdir(ArrayList<Pizza> siparisler){
       int s=0, m=0, l=0;
        ...
        System.out.println("Small Pizza Count = "+s+"  "+PizzaSize.SMALL.fiyat*s);
        System.out.println("Medium Pizza Count = "+m+"  "+PizzaSize.SMALL.fiyat*m);
        System.out.println("Large Pizza Count = "+l+"   "+PizzaSize.SMALL.fiyat*l);
